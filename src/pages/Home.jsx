...
const Home = () => {
 ...
 if(width>=2560){
  ...
  // Specific values for 1920x1080
  scaleValue = 1.05;      // Adjust this - try values between 1.0 - 1.2
  yValue = -50;           // Adjust this - try values between -100 to 0
  startValue = "55% top"  // When navbar animation starts
  midTextStart = "15% 40%"
  bandraStart = "35% top"
}  
else if(width>=1440){
