...
export function InstancedTrees({ 
  ...
  useEffect(() => {
    ...
    console.log(`✅ Updated ${instances.length} instances of ${meshName} at Y=${yPosition}`);
  }, [instances, meshName, yPosition, terrainRef, heightOffset, useTerrainFollowing, dummy, raycaster]);
 ...
 */
export function AllTreeVariants({ nodes, materials, yPosition = 0, terrainRef = null, heightOffset = 0 }) {
  const treeVariants = [
    { meshName: "Tree-Variant-4182_Baked", jsonFile: "Tree-Variation-1-final.json" },
    { meshName: "Tree-Variant-6499_Baked", jsonFile: "Tree-Variation-2-final.json" },
    { meshName: "Tree-Variant-5442_Baked", jsonFile: "Tree-Variation-3-final.json" },
    { meshName: "Tree-variant-1-Baked", jsonFile: "Tree-Variation-4-final.json" },
    { meshName: "Tree-Variant-3807_Baked", jsonFile: "Tree-Variation-5-final.json" },
    { meshName: "Tree-Variant-2991_Baked", jsonFile: "Tree-Variation-6-final.json" },
  ];
