...
export default function FloorComparisonPanel({ 
  ...
  const getFloorOpacity = useCallback((floor) => {
    ...
    return 0.85;
  }, [selectedFloorsArray, hoveredFloor, lockedFloor, getOppositeType]);
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div className="w-2/3 bg-white overflow-y-auto left-panel">
              ...
              {hasSelections ? (
                <div className={`grid gap-6 h-full ${selectedTypes.length === 1 ? 'grid-cols-1' : 'grid-cols-2'}`}>
                  {selectedTypes.map((apartmentType, idx) => {
                    ...
                    const colorSchemes = [
                      { border: '#C4E0FD', bg: '#E8F4FE', text: '#1E5A8E', badge: '#C4E0FD' },
                      { border: '#BDD1B1', bg: '#E8F3E3', text: '#2D5016', badge: '#BDD1B1' }
                    ];
                  ...
                  {floors.map((floor) => {
                    ...
                    return (
                      <path
                        ...
                        stroke={isHovered || isSelected || isLocked ? "#ffffff" : "none"}
                        strokeWidth={isHovered || isSelected || isLocked ? "3" : "0"}
